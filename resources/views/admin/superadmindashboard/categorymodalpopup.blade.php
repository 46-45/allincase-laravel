  		<!-- Category List-->
          <div class="modal fade sprukosearchcategory" data-bs-backdrop="static" id="addcategory" aria-hidden="true">
				...
				<div class="modal-content">
					...
					<form method="POST" enctype="multipart/form-data" id="sprukocategory_form" name="sprukocategory_form">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <div class="custom-controls-stacked d-md-flex" >
									<select class="form-control select4-show-search" data-placeholder="{{lang('Select category')}}" name="category" id="sprukocategorylists" >
                            ...
                            @if(true)
                                <div class="form-group" id="selectssSubCategorydata" style="display: none;">

                                    <label class="form-label mb-0 mt-2">{{lang('Subcategory')}}</label>
                                    <select  class="form-control subcategoryselected"  data-placeholder="{{lang('Select SubCategory')}}" name="subscategory" id="subscategory">
							...
							<div class="form-group" id="envatopurchasedid">
							</div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-secondary" id="categorybtnsave" >{{lang('Save Changes')}}</button>
                        </div>
                    </form>
				</div>
			</div>
